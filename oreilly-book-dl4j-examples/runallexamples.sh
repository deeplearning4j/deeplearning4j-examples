...
"org.deeplearning4j.examples.recurrent.character.LSTMCharModellingExample"
...
do
  echo "$i"
  java -cp dl4j-examples/target/dl4j-examples-1.0.0-beta2-SNAPSHOT-bin.jar "$i"
done
...
do
  echo "$i"
  java -cp datavec-examples/target/datavec-examples-1.0.0-beta2-SNAPSHOT-bin.jar "$i"
done
