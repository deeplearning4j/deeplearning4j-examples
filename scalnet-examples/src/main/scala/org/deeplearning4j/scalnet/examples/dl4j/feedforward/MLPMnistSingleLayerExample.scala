...
/**
  * Single-layer MLP for MNIST using DL4J-style NeuralNet
...
object MLPMnistSingleLayerExample extends App {
  ...
  private val learningRate: Double = 0.006
  ...
  model.add(Dense(nOut = 1000, nIn = numRows * numColumns, weightInit = WeightInit.XAVIER,
    activation = "relu", regularizer = L2(1e-4)))
