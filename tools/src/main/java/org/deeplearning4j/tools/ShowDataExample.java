...
public class ShowDataExample {
	...
	//
	private static String modulCode = "SDE";
	//
	...
	public static void main( String[] args ) throws Exception {
		...
		sis = new SIS();
		//
	//	sis.initValues( mtLv, modulCode, System.out, System.err ); //without file saving
		sis.initValues( mtLv, modulCode, System.out, System.err, "C:\\Info_Files", modulCode, "ABC", true, true );
		// System.getProperty( "user.dir" )
		//
		String methodName = modulCode + "." + "main";
		//
		oinfo = "";
		...
		//
		DL4JTools dl4jt = new DL4JTools( sis, modulCode );
		//
