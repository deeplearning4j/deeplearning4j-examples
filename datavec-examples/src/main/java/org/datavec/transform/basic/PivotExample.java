...
public class PivotExample {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String directory = new ClassPathResource("BasicDataVecExample/PivotExampleData.csv").getFile().getAbsolutePath(); //Normally just define your directory like "file:/..." or "hdfs:/..."
