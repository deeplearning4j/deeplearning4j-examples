...
public class SparkLSTMClinicalTimeSeriesClassificationExample {
    ...
    private static final Logger log = LoggerFactory.getLogger(SparkLSTMClinicalTimeSeriesClassificationExample.class);
