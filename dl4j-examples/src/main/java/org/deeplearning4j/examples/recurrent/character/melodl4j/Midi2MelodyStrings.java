...
//                }
	 ...
	 private void loadPiece(File file) throws InvalidMidiDataException, IOException {
		   ...
		   if (trace) { System.out.println("Resolution = " + sequence.getResolution() + ", divisionType = " + sequence.getDivisionType());}
 ...
 */
	                   ...
	                   if (trace) {System.out.println("Other message: " + message.getClass());}
	                }
	            }
	        }
	 }
