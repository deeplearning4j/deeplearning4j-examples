...
/**
 * This example performs anomaly detection on MNIST using a variational autoencoder, trained with a mean squared
 * error loss function for the output, instead of
 *
 ...
 *
 * For the use of VAEs for anomaly detection using standard reconstruction probability (instead of reconstruction error
 * as in this example) see:
 * -
 *
 *
 ...
 * @author Alex Black
 */
public class VaeMNISTAnomalyMSE {
    private static final Logger log = LoggerFactory.getLogger(VaeMNISTAnomalyMSE.class);
    ...
    public static void main(String[] args) throws IOException {
        ...
        MultiLayerConfiguration conf = new NeuralNetConfiguration.Builder()
            ...
            .layer(0, new VariationalAutoencoder.Builder()
                ...
                .reconstructionDistribution(new LossFunctionWrapper(new ActivationSigmoid(), new LossMSE()))     //Bernoulli distribution for p(data|z) (binary or 0 to 1 data only)
