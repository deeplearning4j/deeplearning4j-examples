...
package org.deeplearning4j.examples.advanced.modeling.textclassification.pretrainedword2vec;
 ...
 * @author Alex Black
 */
public class ImdbReviewClassificationCNN {
    ...
    public static void main(String[] args) throws Exception {
        ...
        String pathFirstNegativeFile = FilenameUtils.concat(ImdbReviewClassificationRNN.DATA_PATH, "aclImdb/test/neg/0_2.txt");
    ...
    private static DataSetIterator getDataSetIterator(boolean isTraining, WordVectors wordVectors, int minibatchSize,
        ...
        String path = FilenameUtils.concat(ImdbReviewClassificationRNN.DATA_PATH, (isTraining ? "aclImdb/train/" : "aclImdb/test/"));
