...
public class BertFrozenSentimentExampleNoDropout2 {
    public static Logger log = LoggerFactory.getLogger(BertFrozenSentimentExampleNoDropout2.class);
...
//        File rootDir = new File("C:/Temp/Bert_Frozen/");
        ...
        File dir = new File(rootDir, "lr_5e-4_2layer_cls_pre_nd_fixtoken");
        dir.mkdirs();
