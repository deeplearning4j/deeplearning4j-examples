...
public class BertFrozenSentimentExampleNoDropoutNoPreFull {
    public static Logger log = LoggerFactory.getLogger(BertFrozenSentimentExampleNoDropoutNoPreFull.class);
...
//        File f = new File(saveDir, "bert_frozen_mb4_len128.pb");
        ...
        File saveDir = new File(rootDir, "bert_notrain_full_mb" + minibatch + "_seq" + seqLength);
