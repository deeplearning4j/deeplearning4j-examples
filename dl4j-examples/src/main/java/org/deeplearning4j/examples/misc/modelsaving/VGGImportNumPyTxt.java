...
public class VGGImportNumPyTxt {

    protected static Logger logger= LoggerFactory.getLogger(VGGImportNumPyTxt.class);
    ...
    public static final String NUMPY_DIR = "/Users/susaneraly/SKYMIND/kerasImport/tests/random3CH/testImages3ChZeros";
