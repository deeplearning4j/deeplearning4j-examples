...
/*
   ...
   ####  FORKED FROM https://github.com/hamaadshah/gan_deeplearning4j   ###


   Download the mnist_train.csv and mnist_test.csv from https://pjreddie.com/projects/mnist-in-csv/
   and put them into the "resources" directory.git
...
public class GANComputerVision {
    private static final Logger log = LoggerFactory.getLogger(GANComputerVision.class);
    ...
    private static final int numGenSamples = 10; // This will be a grid so effectively we get {numGenSamples *
    // numGenSamples} samples.
    ...
    private static final String resPath = "computer_vision";
    private static final String newLine = "\n";
    private static final String dataSetName = "mnist";

    private static final boolean useGpu = true;

    private static String resultsDirPath = System.getProperty("user.home") + File.separator + resPath;
    ...
    public static void main(String[] args) throws Exception {
        ...
        new GANComputerVision().GAN(args);
    }
    ...
    private void GAN(String[] args) throws Exception {
        ...
        ComputationGraph dis = new ComputationGraph(new NeuralNetConfiguration.Builder()
                                                        ...
                                                        .gradientNormalizationThreshold(1.0).l2(0.0001)
                                                        .activation(Activation.TANH).weightInit(WeightInit.XAVIER)
                                                        .graphBuilder().addInputs("dis_input_layer_0")
                                                        .setInputTypes(InputType.convolutionalFlat(tensorDimOneSize,
                                                                                                   tensorDimTwoSize,
                                                                                                   tensorDimThreeSize))
                                                        .addLayer("dis_batch_layer_1",
                                                                  new BatchNormalization.Builder().updater(new RmsProp(
                                                                      dis_learning_rate,
                                                                      1e-8,
                                                                      1e-8)).build(),
                                                                  "dis_input_layer_0").addLayer("dis_conv2d_layer_2",
                                                                  ...
                                                                  "dis_conv2d_layer_2").addLayer("dis_conv2d_layer_4",
                                                                                                 new ConvolutionLayer.Builder(
                                                                                                     ...
                                                                                                     5).stride(2, 2)
                                                                                                       ...
                                                                                                       .build(),
                                                                                                 "dis_maxpool_layer_3")
                                                        .addLayer("dis_maxpool_layer_5",
                                                                  new SubsamplingLayer.Builder(PoolingType.MAX)
                                                                      .kernelSize(2, 2).stride(1, 1).build(),
                                                                  "dis_conv2d_layer_4").addLayer("dis_dense_layer_6",
                                                        ...
                                                        .addLayer("dis_output_layer_7",
                                                                  new OutputLayer.Builder(LossFunctions.LossFunction.XENT)
                                                                      .updater(new RmsProp(dis_learning_rate,
                                                                                           1e-8,
                                                                                           1e-8)).nOut(numClassesDis)
                                                                      .activation(Activation.SIGMOID).build(),
                                                                  "dis_dense_layer_6").setOutputs("dis_output_layer_7")
                                                        .build());
        dis.init();
        ...
        ComputationGraph gen = new ComputationGraph(new NeuralNetConfiguration.Builder()
                                                        ...
                                                        .gradientNormalizationThreshold(1.0).l2(0.0001)
                                                        .activation(Activation.TANH).weightInit(WeightInit.XAVIER)
                                                        .graphBuilder().addInputs("gen_input_layer_0")
                                                        .setInputTypes(InputType.feedForward(zSize)).addLayer(
                "gen_batch_1",
                new BatchNormalization.Builder().updater(new RmsProp(frozen_learning_rate, 1e-8, 1e-8)).build(),
                "gen_input_layer_0").addLayer("gen_dense_layer_2",
                                              new DenseLayer.Builder()
                                                  .updater(new RmsProp(frozen_learning_rate, 1e-8, 1e-8)).nOut(1024)
                                                  .build(),
                                              "gen_batch_1").addLayer("gen_dense_layer_3",
                                                                      new DenseLayer.Builder().updater(new RmsProp(
                                                                          frozen_learning_rate,
                                                                          1e-8,
                                                                          1e-8)).nOut(7 * 7 * 128).build(),
                                                                      "gen_dense_layer_2").addLayer("gen_batch_4",
                                                                                                    new BatchNormalization.Builder()
                                                                                                        ...
                                                                                                        .build(),
                                                                                                    "gen_dense_layer_3")
                                                        .inputPreProcessor("gen_deconv2d_5",
                                                                           new FeedForwardToCnnPreProcessor(7, 7, 128))
                                                        .addLayer("gen_deconv2d_5",
                                                                  new Upsampling2D.Builder(2).build(),
                                                                  "gen_batch_4").addLayer("gen_conv2d_6",
                                                                                          new ConvolutionLayer.Builder(5,
                                                                                                                       5)
                                                                                              .stride(1, 1)
                                                                                              .padding(2, 2)
                                                                                              .updater(new RmsProp(
                                                                                                  ...
                                                                                                  1e-8)).nIn(128)
                                                                                              .nOut(64).build(),
                                                                                          "gen_deconv2d_5").addLayer(
                "gen_deconv2d_7",
                new Upsampling2D.Builder(2).build(),
                "gen_conv2d_6").addLayer("gen_conv2d_8",
                                         new ConvolutionLayer.Builder(5, 5).stride(1, 1).padding(2, 2)
                                                                           .activation(Activation.SIGMOID)
                                                                           .updater(new RmsProp(frozen_learning_rate,
                                                                                                1e-8,
                                                                                                1e-8)).nIn(64).nOut(1)
                                                                           .build(),
                                         "gen_deconv2d_7").setOutputs("gen_conv2d_8").build());
        gen.init();
        ...
        ComputationGraph gan = new ComputationGraph(new NeuralNetConfiguration.Builder()
                                                        ...
                                                        .optimizationAlgo(OptimizationAlgorithm.STOCHASTIC_GRADIENT_DESCENT)
                                                        .gradientNormalization(GradientNormalization.ClipElementWiseAbsoluteValue)
                                                        .gradientNormalizationThreshold(1.0).activation(Activation.TANH)
                                                        .weightInit(WeightInit.XAVIER).l2(0.0001).graphBuilder()
                                                        .addInputs("gan_input_layer_0")
                                                        .setInputTypes(InputType.feedForward(zSize)).addLayer(
                "gan_batch_1",
                new BatchNormalization.Builder().updater(new RmsProp(gen_learning_rate, 1e-8, 1e-8)).build(),
                "gan_input_layer_0").addLayer("gan_dense_layer_2",
                                              new DenseLayer.Builder()
                                                  .updater(new RmsProp(gen_learning_rate, 1e-8, 1e-8)).nOut(1024)
                                                  .build(),
                                              "gan_batch_1").addLayer("gan_dense_layer_3",
                                                                      new DenseLayer.Builder().updater(new RmsProp(
                                                                          gen_learning_rate,
                                                                          1e-8,
                                                                          1e-8)).nOut(7 * 7 * 128).build(),
                                                                      "gan_dense_layer_2").addLayer("gan_batch_4",
                                                                                                    new BatchNormalization.Builder()
                                                                                                        .updater(new RmsProp(
                                                                                                            gen_learning_rate,
                                                                                                            1e-8,
                                                                                                        ...
                                                                                                        .build(),
                                                                                                    "gan_dense_layer_3")
                                                        .inputPreProcessor("gan_deconv2d_5",
                                                                           new FeedForwardToCnnPreProcessor(7, 7, 128))
                                                        .addLayer("gan_deconv2d_5",
                                                                  new Upsampling2D.Builder(2).build(),
                                                                  "gan_batch_4").addLayer("gan_conv2d_6",
                                                                                          new ConvolutionLayer.Builder(5,
                                                                                                                       5)
                                                                                              .stride(1, 1)
                                                                                              .padding(2, 2)
                                                                                              .updater(new RmsProp(
                                                                                                  ...
                                                                                                  1e-8)).nIn(128)
                                                                                              .nOut(64).build(),
                                                                                          "gan_deconv2d_5").addLayer(
                "gan_deconv2d_7",
                new Upsampling2D.Builder(2).build(),
                "gan_conv2d_6").addLayer("gan_conv2d_8",
                                         new ConvolutionLayer.Builder(5, 5).stride(1, 1).padding(2, 2)
                                                                           .activation(Activation.SIGMOID)
                                                                           .updater(new RmsProp(gen_learning_rate,
                                                                                                1e-8,
                                                                                                1e-8)).nIn(64).nOut(1)
                                                                           .build(),
                                         "gan_deconv2d_7")

                                                        .addLayer("gan_dis_batch_layer_9",
                                                                  new BatchNormalization.Builder().updater(new RmsProp(
                                                                      frozen_learning_rate,
                                                                      1e-8,
                                                                      1e-8)).build(),
                                                                  "gan_conv2d_8").addLayer("gan_dis_conv2d_layer_10",
                                                                                           new ConvolutionLayer.Builder(
                                                                                               5,
                                                                                               5).stride(2, 2)
                                                                                                 .updater(new RmsProp(
                                                        ...
                                                        .addLayer("gan_dis_maxpool_layer_11",
                                                                  new SubsamplingLayer.Builder(PoolingType.MAX)
                                                                      .kernelSize(2, 2).stride(1, 1).build(),
                                                                  "gan_dis_conv2d_layer_10").addLayer(
                "gan_dis_conv2d_layer_12",
                new ConvolutionLayer.Builder(5, 5).stride(2, 2).updater(new RmsProp(frozen_learning_rate, 1e-8, 1e-8))
                                                  .nIn(64).nOut(128).build(),
                "gan_dis_maxpool_layer_11").addLayer("gan_dis_maxpool_layer_13",
                                                     new SubsamplingLayer.Builder(PoolingType.MAX).kernelSize(2, 2)
                                                                                                  .stride(1, 1).build(),
                                                     "gan_dis_conv2d_layer_12").addLayer("gan_dis_dense_layer_14",
                                                                                         new DenseLayer.Builder()
                                                                                             .updater(new RmsProp(
                                                                                                 frozen_learning_rate,
                                                                                                 1e-8,
                                                        ...
                                                        .setOutputs("gan_dis_output_layer_15").build());
        gan.init();
        ...
        TrainingMaster tm = new ParameterAveragingTrainingMaster.Builder(batchSizePerWorker).averagingFrequency(10)
        ...
        ComputationGraph computerVision = new TransferLearning.GraphBuilder(sparkDis.getNetwork())
            .fineTuneConfiguration(new FineTuneConfiguration.Builder().trainingWorkspaceMode(WorkspaceMode.ENABLED)
                                                                      .inferenceWorkspaceMode(WorkspaceMode.ENABLED)
                                                                      .optimizationAlgo(OptimizationAlgorithm.STOCHASTIC_GRADIENT_DESCENT)
                                                                      .gradientNormalization(GradientNormalization.ClipElementWiseAbsoluteValue)
                                                                      .gradientNormalizationThreshold(1.0)
                                                                      .activation(Activation.TANH).l2(0.0001)
                                                                      .weightInit(WeightInit.XAVIER)
                                                                      .updater(new RmsProp(dis_learning_rate,
                                                                                           1e-8,
                                                                                           1e-8)).seed(numberOfTheBeast)
                                                                      .build()).setFeatureExtractor("dis_dense_layer_6")
            .removeVertexKeepConnections("dis_output_layer_7").addLayer("dis_batch",
                                                                        new BatchNormalization.Builder()
                                                                            .updater(new RmsProp(dis_learning_rate,
                                                                                                 1e-8,
                                                                                                 1e-8)).nIn(1024)
                                                                            .nOut(1024).build(),
                                                                        "dis_dense_layer_6").addLayer(
                "dis_output_layer_7",
                new OutputLayer.Builder(LossFunctions.LossFunction.MCXENT)
                    .updater(new RmsProp(dis_learning_rate, 1e-8, 1e-8)).nIn(1024).nOut(numClasses)
        ...
        DataSetIterator iterTest = new RecordReaderDataSetIterator(recordReaderTest,
                                                                   batchSizePred,
                                                                   labelIndex,
                                                                   numClasses);
        ...
        while (iterTrain.hasNext() && batch_counter < numIterations) {
            ...
            // [Fake, Real].
            trainDataList
                .add(new DataSet(trDataSet.getFeatures(), Nd4j.ones(batchSizePerWorker, 1).addi(soften_labels_real)));

            // ...and this is fake data.
            // [Fake, Real].
            trainDataList.add(new DataSet(gen.output(Nd4j.rand(batchSizePerWorker, zSize).muli(2.0).subi(1.0))[0],
            ...
            sparkGan.getNetwork().getLayer("gan_dis_batch_layer_9")
                    .setParam("gamma", sparkDis.getNetwork().getLayer("dis_batch_layer_1").getParam("gamma"));
            sparkGan.getNetwork().getLayer("gan_dis_batch_layer_9")
                    .setParam("beta", sparkDis.getNetwork().getLayer("dis_batch_layer_1").getParam("beta"));
            sparkGan.getNetwork().getLayer("gan_dis_batch_layer_9")
                    .setParam("mean", sparkDis.getNetwork().getLayer("dis_batch_layer_1").getParam("mean"));
            sparkGan.getNetwork().getLayer("gan_dis_batch_layer_9")
                    .setParam("var", sparkDis.getNetwork().getLayer("dis_batch_layer_1").getParam("var"));
            ...
            if ((batch_counter % printEvery) == 0) {
                ...
                FileWriter fileWriter = new FileWriter(String.format("%s%s_out_%d.csv",
                                                                     resPath,
                                                                     dataSetName,
                                                                     batch_counter));
            ...
            if ((batch_counter % saveEvery) == 0) {
                ...
                FileWriter fileWriter = new FileWriter(String.format("%s%s_test_predictions_%d.csv",
                                                                     resPath,
                                                                     dataSetName,
                                                                     batch_counter));
        ...
        ModelSerializer.writeModel(sparkDis.getNetwork(),
                                   new File(resultsDirPath + File.separator + dataSetName + "_dis_model.zip"),
                                   true);
        ModelSerializer.writeModel(sparkGan.getNetwork(),
                                   new File(resultsDirPath + File.separator + dataSetName + "_gan_model.zip"),
                                   true);
        ModelSerializer
            .writeModel(gen, new File(resultsDirPath + File.separator + dataSetName + "_gen_model" + ".zip"), true);
        ModelSerializer.writeModel(sparkCV.getNetwork(),
                                   new File(resultsDirPath + File.separator + dataSetName + "_CV_model.zip"),
                                   true);
