...
public class CustomSequenceIterator implements MultiDataSetIterator {
    ...
    private static final int numDigits = AdditionRNNDistributedExample.NUM_DIGITS;
    public static final int SEQ_VECTOR_DIM = AdditionRNNDistributedExample.FEATURE_VEC_SIZE;
