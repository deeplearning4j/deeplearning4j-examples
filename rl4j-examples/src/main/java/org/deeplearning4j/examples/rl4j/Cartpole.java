...
public class Cartpole {
    ...
    private static QLearningConfiguration CARTPOLE_Q_LEARNING_CONFIG = QLearningConfiguration.builder()
        .gamma(0.95)
        .minEpsilon(0.01)
        .epsilonNbStep(1000)
        .build();
    ...
    public static void cartPole() throws IOException {
        ...
        //define the training
        QLearningDiscreteDense<Box> dql = new QLearningDiscreteDense(mdp, CARTPOLE_NET_CONFIG, CARTPOLE_Q_LEARNING_CONFIG, manager);
