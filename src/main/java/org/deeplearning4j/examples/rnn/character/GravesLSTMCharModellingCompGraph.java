...
/**GravesLSTM Character modelling example using ComputationGraph with the following changes:
 * (a) Using the ComputationGraph instead of the MultiLayerNetwork architecture
 * (b) The addition of skip connections (i.e., we have first -> second and (first + second) -> outputLayer)
 * Otherwise, this is the same as GravesLSTMCharModellingExample; see that file for details.
 * @author Alex Black
 */
public class GravesLSTMCharModellingCompGraph {
	...
	public static void main( String[] args ) throws Exception {
		...
		CharacterIterator iter = GravesLSTMCharModellingExample.getShakespeareIterator(miniBatchSize, exampleLength, examplesPerEpoch);
		...
		ComputationGraphConfiguration conf = new NeuralNetConfiguration.Builder()
			...
			.addLayer("outputLayer", new RnnOutputLayer.Builder(LossFunction.MCXENT).activation("softmax")        //MCXENT + softmax for classification
					.updater(Updater.RMSPROP)
